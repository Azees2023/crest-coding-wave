      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        >
          <motion.h1
            ...
            className="text-4xl sm:text-6xl lg:text-7xl font-poppins font-bold text-white leading-tight"
          >
            Hi, I'm{' '}
            <span className="relative">
              <motion.span
                initial={{ width: 0 }}
                animate={{ width: '100%' }}
                transition={{ delay: 1, duration: 2, ease: "steps(20)" }}
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl text-white/90 font-inter max-w-2xl mx-auto leading-relaxed"
          >
